...
class Forum(models.Model):
    category = models.ForeignKey(Category, related_name='forums', verbose_name=u'категория')
    ...
    class Meta:
        verbose_name = u'форум'
        verbose_name_plural = u'форумы'
        ordering = ['position']
    ...
    def get_absolute_url(self):
        return ('forums:forum', (), {'pk': self.id})


class Topic(models.Model):
    forum = models.ForeignKey(Forum, related_name='topics', verbose_name=u'форум')
    name = models.CharField(_("Name"), max_length=255)
    ...
    @models.permalink
    def get_absolute_url(self):
        return ('forums:topic', (), {'pk': self.id})


class Post(models.Model):
    topic = models.ForeignKey(Topic, related_name='posts', verbose_name=u'топик')
